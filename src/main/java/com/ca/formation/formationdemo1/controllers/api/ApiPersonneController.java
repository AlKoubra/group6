...
public class ApiPersonneController {
    ...
    @GetMapping("/{id}")
     ResponseEntity<Personne> getPersonne(@PathVariable(value="id") Long id) throws ResourceNotFoundException {
    ...
    @PatchMapping("/{id}")
     ResponseEntity<Personne> updatePersonne(@PathVariable(value="id") Long id, @RequestBody Personne personneRequest ) throws Exception {
    ...
    @DeleteMapping("/{id}")
    String deletePersonne(@PathVariable(value="id") Long id){
        personneService.deletePersonne(id);
        return "OK";
    }

    @GetMapping("/search")
     ResponseEntity<List<Personne>> getPersonneParNom(@RequestParam(name = "nom") String nom){
