...
public class UtilisateurController {
    ...
    UtilisateurController(UtilisateurService utilisateurService, JwtUtil jwtUtil) {
        this.utilisateurService = utilisateurService;
        this.jwtUtil = jwtUtil;
    }

    @PostMapping("/login")
     ResponseEntity<Utilisateur> login(@RequestBody Utilisateur utilisateurRequest){
        try{
    ...
    @PostMapping("/registration")
     ResponseEntity<Utilisateur> registration(@RequestBody Utilisateur utilisateurRequest){
